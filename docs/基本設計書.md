...
- 作成日: 2026-09-09
- 前提資料: [要件定義書](./要件定義書.md)（8章34項目中32件解決・2件保留の状態を前提とする）
- ステータス: ドラフト（レビュー前）
...
| 項目 | 設計方針 |
|---|---|
| データ保持期間 | シフト・予約とも当年+3年分を保持。職員・利用者・車両マスタは削除機能を設けず、この矛盾を回避する（要件定義書8.1項目26参照）。監査ログも同様に当年+3年分を保持する（要件定義書8.1項目32参照） |

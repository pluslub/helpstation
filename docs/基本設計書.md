...
| applied_am_off / applied_pm_off | BOOLEAN | NOT NULL | 社員が申請した午前休／午後休 |
| applied_desired_off | BOOLEAN | NOT NULL | 希望休フラグ（職員本人の申請による休み） |
...
| vehicle_id | INT | FK → vehicle.id, NULL可 | 介護専用車両／普通社用車を割り当てた場合。車不要・私用車の場合はNULL |
